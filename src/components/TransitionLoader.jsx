    ...
    <div className="fixed inset-0 bg-black flex items-center justify-center z-50">
      <div className="text-center">
        ...
        >
          <div className="w-24 h-24 mx-auto relative">
            ...
            <motion.div
              ...
              className="absolute inset-2 border-2 border-transparent border-t-blue-400 border-l-purple-400 rounded-full"
            ></motion.div>
          </div>
        </motion.div>
        ...
        <motion.p
          ...
          className="font-exo text-gray-300 text-lg mb-6"
        >
          Engaging warp drive to the mission dashboard.
        </motion.p>
